...
export const addImagesApiKey = fs.readFileSync('/var/www/html/atphotobackend/add_imgs_api_key.txt').toString().trim();
...
export const postgresDB = new Pool({
  ...
  password: fs.readFileSync('/var/www/html/atphotobackend/postgres_pass.txt').toString().trim(),
  ssl: {
    rejectUnauthorized: true,
    ca: fs.readFileSync('/var/www/html/atphotobackend/us-east-2-bundle.pem').toString(),
  },
  max: 20,
